...
data1=data_origin(data_train_test.copy())
...
#yuce_data.to_csv('yuce_data.csv',index=None)
#tr_data.to_csv('tr_data.to_csv',index=None)
...
joblib.dump(lgb_model,'fusai201851.pkl')
...
print(string_feat)
string_nofeat=feat_imp[feat_imp.values !=0].index.tolist()
pd.DataFrame(string_nofeat).to_csv('string_nofeat.csv',index=None)
