# -*- coding: utf-8 -*-
"""
Created on Thu Apr 19 21:02:38 2018
...
#get_catefory=pd.get_dummies(new_data.item_category_list,prefix='item_category_list')
#new_data=pd.concat([new_data,get_catefory],axis=1)
#
#string_can=['item_price_level','item_sales_level','item_collected_level','item_pv_level','item_city_id','user_gender_id','user_age_level','user_occupation_id','user_star_level','shop_review_num_level','shop_star_level']
#dict2={}
#for ss in string_can:
#    dict2[ss]=new_data[ss].value_counts().size

#for ss in string_can:
#    locals()['new_'+ss]=pd.get_dummies(new_data[ss],prefix=ss)
#    new_data=pd.concat([new_data,locals()['new_'+ss]],axis=1)
...
bao_cun.to_csv('b20184231_0780709.txt',index=False,sep=' ')
