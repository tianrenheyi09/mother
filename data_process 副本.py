...
all_two_data=pd.merge(all_two_data,item_cate_proper,on=['item_category_list','item_property_list_m1'],how='left')
...
u1['is_new_user_item']=1
u1.loc[(u1.time_delta_user_item==-1),'is_new_user_item']=0

time_delta_user_item=u1
##########用户是否是第一次浏览该商品

for i in range(len(time_delta_user_item)):
...
string3=['item_id','item_category_list','item_brand_id','item_city_id','user_gender_id','user_id','user_age_level','user_occupation_id','shop_id', 'item_property_list_m1', 'item_property_list_m2', 'item_property_list_m3','hour', 'predict_category_property_m1',]
