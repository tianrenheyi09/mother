...
u1['user_item_pro_m1_day_times']=1
user_item_pro_m1_day_sum=u1.groupby(['user_id','item_property_list_m1','day']).agg('sum').reset_index()

u1['user_item_pro_m1_cumsum']=u1.groupby(['user_id','item_property_list_m1'])['user_item_pro_m1_day_times'].cumsum()
u1['user_item_pro_m1_day_cumsum']=u1.groupby(['user_id','item_property_list_m1','day'])['user_item_pro_m1_day_times'].cumsum()
user_item_pro_m1_day_cumsum=u1.drop(['user_id','item_property_list_m1','day','user_item_pro_m1_day_times'],axis=1)



u1=data[['user_id','item_property_list_m2','day']]
u1['user_item_pro_m2_day_times']=1
user_item_pro_m2_day_sum=u1.groupby(['user_id','item_property_list_m2','day']).agg('sum').reset_index()

u1['user_item_pro_m2_cumsum']=u1.groupby(['user_id','item_property_list_m2'])['user_item_pro_m2_day_times'].cumsum()
u1['user_item_pro_m2_day_cumsum']=u1.groupby(['user_id','item_property_list_m2','day'])['user_item_pro_m2_day_times'].cumsum()
user_item_pro_m2_day_cumsum=u1.drop(['user_id','item_property_list_m2','day','user_item_pro_m2_day_times'],axis=1)


u1=data[['user_id','item_property_list_m3','day']]
u1['user_item_pro_m3_day_times']=1
user_item_pro_m3_day_sum=u1.groupby(['user_id','item_property_list_m3','day']).agg('sum').reset_index()

u1['user_item_pro_m3_cumsum']=u1.groupby(['user_id','item_property_list_m3'])['user_item_pro_m3_day_times'].cumsum()
u1['user_item_pro_m3_day_cumsum']=u1.groupby(['user_id','item_property_list_m3','day'])['user_item_pro_m3_day_times'].cumsum()
user_item_pro_m3_day_cumsum=u1.drop(['user_id','item_property_list_m3','day','user_item_pro_m3_day_times'],axis=1)




###########item_property_list_m1
...
u1['item_pro_m1_cusum']=u1.groupby(['item_property_list_m1'])['item_pro_m1_day_times'].cumsum()
...
u1['item_pro_m2_cusum']=u1.groupby(['item_property_list_m2'])['item_pro_m2_day_times'].cumsum()
...
u1['item_pro_m3_cusum']=u1.groupby(['item_property_list_m3'])['item_pro_m3_day_times'].cumsum()
...
all_time_data=pd.merge(all_time_data,user_item_pro_m1_day_sum,on=['user_id','item_property_list_m1','day'],how='left')
all_time_data=pd.merge(all_time_data,user_item_pro_m2_day_sum,on=['user_id','item_property_list_m2','day'],how='left')
all_time_data=pd.merge(all_time_data,user_item_pro_m3_day_sum,on=['user_id','item_property_list_m3','day'],how='left')
all_time_data=pd.concat([all_time_data,user_item_pro_m1_day_cumsum],axis=1,join='outer')
all_time_data=pd.concat([all_time_data,user_item_pro_m2_day_cumsum],axis=1,join='outer')
all_time_data=pd.concat([all_time_data,user_item_pro_m3_day_cumsum],axis=1,join='outer')
...
string3=['item_id','item_category_list','item_brand_id','item_city_id','user_id','user_gender_id','user_age_level','user_occupation_id','context_page_id','shop_id', 'item_property_list_m1', 'item_property_list_m2', 'hour','item_property_list_m3','predict_category_property_m1']
#
...
bao_cun.to_csv('2018491.txt',index=False,sep=' ')
