...
####第七天的用户是否出现在第6天
string_day7=['user_id','item_id']
sa=list(data_day6.user_id)
user_day7=tr_data.user_id.apply(lambda x:is_in(x,sa))
...
#bao_cun.to_csv('round2_result/lgb0170842.txt',index=False,sep=' ')
#
